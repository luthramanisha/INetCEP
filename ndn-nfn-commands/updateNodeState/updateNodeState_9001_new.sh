...
#9001 node will start iperf on 8001:
xterm -iconic -hold -e iperf -s -p 8001 -u  &
sleep 5
...
do 
	...
	xterm -e $CCNL_HOME/build/bin/ccn-lite-simplenfn -s ndn2013 -u $ParentIP/$ParentPort -w 30 "call 3 /node/$ParentNodeName/nfn_service_SACEPICN_UpdateNodeState '$MyPort' '$Content'" | $CCNL_HOME/build/bin/ccn-lite-pktdump -f 3 &
